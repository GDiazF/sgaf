...
import { Key, Users, Home, ClipboardList, ChevronDown, ChevronRight, Menu, Building, LogOut, DollarSign, FileText, Phone, Printer, Truck, Cog, Activity, Shield } from 'lucide-react';
                            ...
                            <AnimatePresence>
                                {isSSGGOpen && (sidebarOpen || mobileMenuOpen) && (
                                    ...
                                    >
                                        ...
                                        {/* Section: RECURSOS */}
                                        {(can('servicios.view_servicio') || can('impresoras.view_printer') || can('vehiculos.view_registromensual') || can('prestamo_llaves.view_prestamo')) && (
                                            <div className="space-y-0.5">
                                                <div className="px-4 mb-1">
                                                    <span className="text-[10px] uppercase tracking-widest font-bold text-slate-500">
                                                        Recursos
