                                    ...
                                    <tr key={item.id} className="hover:bg-slate-50 transition-colors text-xs">
                                        <td className="p-3">
                                            {can('funcionarios.change_grupo') ? (
                                                ...
                                                <div className={`flex items-center gap-2 px-3 py-1 rounded-full text-[9px] font-black w-fit ${item.activo ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-500'}`}>
                                                    <Power className="w-3 h-3" />
                                                    {item.activo ? 'ACTIVO' : 'INACTIVO'}
                                                </div>
                                            )}
