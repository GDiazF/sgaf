...
import { Building2, Plus, Edit2, Trash2, Search, ArrowLeft } from 'lucide-react';
...
const Subdirecciones = () => {
    ...
    const filteredData = subdirecciones.filter(item =>
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div className="flex flex-col gap-4">
                    <Link
                        to="/funcionarios"
                        className="flex items-center gap-2 text-gray-500 hover:text-purple-600 transition-colors w-fit group"
                    >
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Gestión de subdirecciones</p>
                    </div>
                </div>
                <button
                    onClick={() => setShowModal(true)}
                    className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-semibold shadow-lg shadow-purple-500/30 transition-all flex items-center gap-2"
                >
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {filteredData.map((item) => (
                                    <tr key={item.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 text-gray-600">{item.piso}</td>
                                        <td className="px-6 py-4 text-gray-600">{item.total_departamentos || 0}</td>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    ...
                    >
                        <h2 className="text-2xl font-bold mb-4">{editingId ? 'Editar' : 'Nueva'} Subdirección</h2>
