...
const Departamentos = () => {
    ...
    const handleToggleActivo = async (item) => {
        ...
        if (!confirm(`¿Estás seguro de que deseas ${accion} este departamento?`)) return;
        try {
        ...
        <div className="flex flex-col h-[calc(100vh-170px)] gap-4 overflow-hidden">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-medium text-slate-500 mt-1 flex items-center gap-2">
                            ...
                            Administración de Departamentos ({totalResults})
                        </p>
                    </div>
                </div>
                {can('funcionarios.add_departamento') && (
                    <button
                ...
                <div className="p-4 border-b border-slate-100 bg-slate-50/50 flex flex-row justify-between items-center gap-3 shrink-0">
                    <div className="relative flex-1 max-w-md">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-3 py-2 bg-white border border-slate-200 rounded-xl text-[11px] focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                        />
                    </div>
                    <div className="flex items-center gap-2 shrink-0">
                        ...
                        <select
                            ...
                            className="w-[70px] sm:w-[80px] px-3 py-2 bg-white border border-slate-200 rounded-xl text-[11px] font-bold text-slate-600 focus:ring-2 focus:ring-emerald-500 outline-none transition-all pr-8 appearance-none"
                        >
                                ...
                                >
                                    <div className="flex justify-between items-start">
                                        <div className="flex flex-col gap-1 pr-12">
                                            <span className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Departamento</span>
                                            <h3 className="text-sm font-bold text-slate-900 leading-tight">{item.nombre}</h3>
                                            <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-tighter truncate max-w-[200px]">{item.subdireccion_nombre}</span>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3 py-3 border-y border-slate-50">
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-xs font-black text-blue-600">{item.total_unidades || 0}</span>
                                        </div>
                            ...
                            <table className="w-full text-left whitespace-nowrap">
                                <thead className="bg-slate-50 sticky top-0 z-10 border-b border-slate-200">
                                    <tr>
                                        ...
                                        <th className="p-4 text-xs font-semibold text-slate-500 uppercase tracking-wider text-center">Unidades</th>
                                    ...
                                    {departamentos.map((item) => (
                                        <tr key={item.id} className="hover:bg-slate-50 transition-colors group">
                                            ...
                                            <td className="py-1 px-4 text-center">
                                                <span className="px-2 py-0.5 bg-blue-50 text-blue-600 rounded-md text-[10px] font-bold uppercase border border-blue-100">
            ...
            <div className="shrink-0 pt-2 flex flex-col sm:flex-row items-center justify-between gap-4 pb-2">
                <div className="order-2 sm:order-1">
                    <span className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">Planificación Departamental</span>
                </div>
                        ...
                        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                            ...
                            >
                                <div className="p-4 pb-2">
                                    ...
                                    <p className="text-sm font-medium text-slate-500">Organiza la gestión técnica</p>
                                </div>
