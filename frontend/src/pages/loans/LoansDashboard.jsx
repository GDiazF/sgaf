...
const Dashboard = () => {
    ...
    const fetchLoans = async () => {
        try {
            const response = await api.get('prestamos/?active=true');
        ...
        <div>
                ...
                <div className="space-y-4 flex-1">
                    ...
                    <div className="relative max-w-xs">
                        ...
                        <input
                            type="text"
                            placeholder="Buscar..."
                            className="pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-lg text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full"
                        />
                    </div>
                </div>
            ...
            {loans.length === 0 ? (
                <div className="bg-white p-12 rounded-2xl shadow-sm border border-slate-100 text-center">
                    ...
                    <p className="text-slate-500 max-w-sm mx-auto">No hay llaves prestadas en este momento. Todas las llaves deberían estar en su lugar.</p>
                </div>
            ) : (
