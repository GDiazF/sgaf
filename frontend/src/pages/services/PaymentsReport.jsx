...
const PaymentsReport = () => {
    ...
    const fetchData = async (page = 1, size = pageSize) => {
        setLoading(true);
        try {
            // Clean up parameters: only include those that have a value
            const params = {
                page,
                page_size: size,
                ordering: ordering,
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                ...
                <div className="relative">
                    ...
                    <input
                        type="text"
                        placeholder="Buscar por Nro Cliente, Nro Documento o Nombre de Jardín..."
                        className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-medium text-slate-700 outline-none focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all"
                        value={searchTerm}
